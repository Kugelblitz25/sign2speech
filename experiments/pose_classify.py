...
train = train_data.merge(train_pose_data, left_on="Video file", right_on="video", how="inner", suffixes=("_data", "_pose"))
val = val_data.merge(val_pose_data, left_on="Video file", right_on="video", how="inner", suffixes=("_data", "_pose"))
test = test_data.merge(test_pose_data, left_on="Video file", right_on="video", how="inner", suffixes=("_data", "_pose"))
...
for epoch in range(100):
    ...
    print(f"Epoch {epoch+1}/{100}, Train Loss: {train_loss:.4f}, Train Accuracy: {train_acc:.4f}, Val Loss: {val_loss:.4f}, Validation Accuracy: {val_acc:.4f},")
